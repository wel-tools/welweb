...
describe('WelWeb.lib.providers', async function () {


    describe('#constructor()', function () {

        it('should create a full instance', function () {
            let provider = new WelWeb.providers.HttpProvider(FULL_NODE_API);
            assert.instanceOf(provider, WelWeb.providers.HttpProvider);

            provider = new WelWeb.providers.HttpProvider
            ('www.exaple.com');
            assert.instanceOf(provider, WelWeb.providers.HttpProvider);
        });
        ...
        it('should throw if the host is not valid', function () {
            ...
            assert.throws(() => new WelWeb.providers.HttpProvider(
                '$' + FULL_NODE_API
    ...
    describe('#setStatusPage()', function () {
        ...
        it('should set a status page', function () {
            const provider = new WelWeb.providers.HttpProvider(FULL_NODE_API);
    ...
    describe('#isConnected()', function () {
        ...
        it('should return false if the url is not one of the expected provider', async function () {
            const provider = new WelWeb.providers.HttpProvider('https://google.com');
